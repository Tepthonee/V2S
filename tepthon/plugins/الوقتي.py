...
autopic_path = os.path.join(os.getcwd(), "tepthon", "original_pic.png")
digitalpic_path = os.path.join(os.getcwd(), "tepthon", "digital_pic.png")
autophoto_path = os.path.join(os.getcwd(), "tepthon", "photo_pfp.png")
    ...
    while DIGITALPICSTART:
        if not os.path.exists(digitalpic_path):
            ...
            while not downloader.isFinished():
                pass
        zedfont = gvarstatus("DEFAULT_PIC") or "tepthon/helpers/styles/Papernotes.ttf"
